 ...
 */
final class Version20220203043403 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE customer ADD image VARCHAR(255) NOT NULL, CHANGE gender gender enum(\'Male\', \'Female\')');
    }
